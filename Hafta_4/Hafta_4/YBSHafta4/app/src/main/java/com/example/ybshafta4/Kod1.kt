...
fun main(){
    ...
    my_list3.forEach { println(it) }

    println("--------------------------------------------------------")
    var my_list4 = mutableListOf<Int>(2,8,4,5,11,17,29,36,37,0,6,23)
    ...
    println(my_list4.filter { it%2 !=0 })
    ...
    for((my_key,my_value) in my_map_2)
    {
        ...
        my_map_2[my_key] = yeni_maas.toInt()
    }
    println("--------------------------------------------------------")
